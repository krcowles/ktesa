            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a id="gps_modal" class="dropdown-item"
                            href="#">GPS Tracking...</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
...
<!-- GPS Tracking Modal -->
<div id="gtrk" class="modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <p id="gstate">Off</p>
                <h5>Ensure the 'Location' setting is enabled for your browser</h5>
                <button type="button" class="btn btn-success"
                    id="gon">Turn On Tracking</button><br /><br />
                <button type="button" class="btn btn-success"
                    id="goff">Turn Off Tracking</button><br /><br />
                <button type="button" class="btn btn-success"
                    id="gdwnld">Download Current Track</button><br /><br />
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary"
                    data-bs-dismiss="modal">Close</button>
