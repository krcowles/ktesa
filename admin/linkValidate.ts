 ...
 */
const subsetScan = (remaining: number, first: number, size: number): void => {
...
$(function() {
    ...
    $('#test').on('click', function() {
        var new_size = $('#new_size').val() as string;
        test_size =parseInt(new_size);
        $('#loading').show();
        var first_link = $('#start').val() as string;
