...
CREATE TABLE `EWAYPTS` (
    ...
    CONSTRAINT `EWAYPTS_Constraint` FOREIGN KEY (`indxNo`)
    REFERENCES `EHIKES`(`indxNo`) ON DELETE CASCADE ON UPDATE CASCADE
  ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
ETBL;
...
file_put_contents("gps_wpts.json", $gpx_wpts);
echo "Updated<br/>";
*/
/**
...
$wpt_object = file_get_contents("gps_wpts.json");
