var markerClusterer = (function (t) {
    ...
    const o = (t, e, r, o) => {
        ...
        h = (t, e) => ({ northEast: e.fromLatLngToDivPixel(t.getNorthEast()), southWest: e.fromLatLngToDivPixel(t.getSouthWest()) }),
        l = (t, e) => {
    ...
    class p extends u {
        ...
        calculate(t) {
            ...
            return s.getZoom() >= this.maxZoom ? { clusters: this.noop({ markers: e }), changed: !1 } : { clusters: this.cluster({ markers: o(s, r, e, this.viewportPadding), map: s, mapCanvasProjection: r }) };
        }
    }
    ...
    class w {
        ...
        constructor(t, e = 64, s = Float64Array, r) {
            ...
            r && r instanceof ArrayBuffer
                ? ((this.data = r), (this.ids = new this.IndexArrayType(this.data, 8, t)), (this.coords = new this.ArrayType(this.data, 8 + n + a, 2 * t)), (this._pos = 2 * t), (this._finished = !0))
    ...
    const P = { minZoom: 0, maxZoom: 16, minPoints: 2, radius: 40, extent: 512, nodeSize: 64, log: !1, generateId: !1, reduce: null, map: (t) => t },
    ...
    class O {
        ...
        _addTileFeatures(t, e, s, r, o, i) {
            for (const n of t) {
                ...
                const u = { type: 1, geometry: [[Math.round(this.options.extent * (l * o - s)), Math.round(this.options.extent * (c * o - r))]], tags: h };
                let p;
    ...
    function Z(t, e, s) {
        return { type: "Feature", id: t[e + A], properties: I(t, e, s), geometry: { type: "Point", coordinates: [((r = t[e]), 360 * (r - 0.5)), S(t[e + 1])] } };
        var r;
    }
    function I(t, e, s) {
        const r = t[e + b],
    ...
    class z extends u {
        constructor(t) {
            ...
            super({ maxZoom: s }), (this.state = { zoom: -1 }), (this.superCluster = new O(Object.assign({ maxZoom: this.maxZoom, radius: r }, o)));
        }
        calculate(t) {
            let e = !1;
            ...
            if (!f(t.markers, this.markers)) {
                ...
                const r = this.markers.map((t) => {
                    ...
                    return { type: "Feature", geometry: { type: "Point", coordinates: [e.lng(), e.lat()] }, properties: { marker: t } };
                });
                this.superCluster.load(r);
            }
            return e || ((this.state.zoom <= this.maxZoom || r.zoom <= this.maxZoom) && (e = !f(this.state, r))), (this.state = r), e && (this.clusters = this.cluster(t)), { clusters: this.clusters, changed: e };
        }
        cluster(t) {
            let { map: e } = t;
        ...
        transformCluster(t) {
            ...
            if (i.cluster) return new r({ markers: this.superCluster.getLeaves(i.cluster_id, 1 / 0).map((t) => t.properties.marker), position: { lat: o, lng: e } });
            const n = i.marker;
    ...
    class U {
        constructor(t, e) {
            ...
            this.clusters = { count: e.length, markers: { mean: r / e.length, sum: r, min: Math.min(...s), max: Math.max(...s) } };
        }
    }
    class B {
        render(t, e, r) {
            ...
            const l = { position: i, zIndex: h, title: a, icon: { url: `data:image/svg+xml;base64,${btoa(n)}`, anchor: new google.maps.Point(25, 25) } };
    ...
    return (
        ...
        (t.GridAlgorithm = class extends p {
            constructor(t) {
                ...
                super(e(t, ["maxDistance", "gridSize"])), (this.clusters = []), (this.state = { zoom: -1 }), (this.maxDistance = s), (this.gridSize = r);
            }
            calculate(t) {
                let { markers: e, map: s, mapCanvasProjection: r } = t;
                ...
                return (
                    ...
                    (this.state = i),
                    s.getZoom() >= this.maxZoom ? { clusters: this.noop({ markers: e }), changed: n } : { clusters: this.cluster({ markers: o(s, r, e, this.viewportPadding), map: s, mapCanvasProjection: r }) }
                );
            }
            cluster(t) {
                let { markers: e, map: s, mapCanvasProjection: r } = t;
        ...
        (t.MarkerClusterer = class extends D {
            ...
            render() {
                ...
                if (e instanceof google.maps.Map && e.getProjection()) {
                    ...
                    const { clusters: r, changed: o } = this.algorithm.calculate({ markers: this.markers, map: e, mapCanvasProjection: this.getProjection() });
                    if (o || null == o) {
                        const t = new Set();
        ...
        (t.SuperClusterViewportAlgorithm = class extends p {
            constructor(t) {
                ...
                super({ maxZoom: s, viewportPadding: o }), (this.superCluster = new O(Object.assign({ maxZoom: this.maxZoom, radius: r }, i))), (this.state = { zoom: -1, view: [0, 0, 0, 0] });
            }
            calculate(t) {
                const e = { zoom: Math.round(t.map.getZoom()), view: n(t.map.getBounds(), t.mapCanvasProjection, this.viewportPadding) };
                ...
                return r && ((this.clusters = this.cluster(t)), (this.state = e)), { clusters: this.clusters, changed: r };
            }
            cluster(t) {
