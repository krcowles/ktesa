...
var navht = navbox.getBoundingClientRect();
var logoht = logobox.getBoundingClientRect();
var rule_top = navbox.clientHeight + logobox.clientHeight + "px";
var side_top = navbox.clientHeight + logobox.clientHeight + 40 + "px";
 ...
 */
var map_img = document.getElementById('nm');
var map_dims = map_img.getBoundingClientRect();
var offset = 0.05 * map_dims.height;
var tray_box = document.getElementById('tray');
