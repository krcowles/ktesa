    ...
    function gotoPage(content) {
        ...
        switch (content.trim()) {
            ...
            case 'Forgot Password':
                modal.open({ content: lost_password, height: '140px', width: '240px',
                    id: 'resetpass' });
                return;
            ...
            case 'About this site':
                ...
                break;
            case 'Contact Us':
                var suplink = document.getElementById("support");
                suplink.click();
                break;
            case 'Accept Cookies':
                var accept = { choice: 'accept' };
                $.ajax({
            ...
            case 'Reject Cookies':
                ...
                return;
            case 'Privacy Policy':
                var policy = '../php/postPDF.php?doc=../accounts/PrivacyPolicy.pdf';
