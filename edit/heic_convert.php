 ...
 * them to .jpg. Since conversion loses metadata, first the metaddata is
 * extracted from the .heic file, then converted to .jpg, then readded.
 * The jpg's may now be uploaded to tab2.
 * PHP Version 7.4
 * 
 * @package Ktesa
...
<a id="anchor" style="display:none" download>Download jpg</a>
...
<div id="previews">
    <div id="phdrs">
        <p>Preview area: Click to download to your machine</p>
    </div>
</div>
