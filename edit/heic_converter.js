...
const $anchor = $('#anchor'); // prototype for links
const downloads = document.getElementById('dwnlds');
...
async function convertHeicToJpg(input) {
...
function uploadImage(url, filename, hikeno, height, width, lat, lng, date, mappable, linkid, def) {
    const canvas_img = document.createElement("img");
    canvas_img.onload = () => {
